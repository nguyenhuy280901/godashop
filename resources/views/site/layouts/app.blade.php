...
<html>
    ...
    <body>
        @if(Session::has('message') && Session::has('status'))
            <div class="alert-{{ Session::get('status') == "error" ? "danger" : "success" }} text-center">
                <strong style="font-size: 16px;">{{ Session::get('message') }}</strong>
            </div>
        @endif
        <header>
            <!-- use for ajax -->
            <input type="hidden" id="reference" value="{{ env('APP_URL') }}"> 
            <!-- Top Navbar -->
            <div class="top-navbar container-fluid">
                <div class="menu-mb">
                    <a href="javascript:void(0)" class="btn-close" onclick="closeMenuMobile()">×</a>
                    <a class="{{ Route::is('home') ? "active" : "" }}" href="{{ route('home') }}">Trang chủ</a>
                    <a class="{{ Route::is('product.*') ? "active" : "" }}" href="{{ route('product.index') }}">Sản phẩm</a>
                    <a class="{{ Route::is('return-policy') ? "active" : "" }}" href="{{ route('return-policy') }}">Chính sách đổi trả</a>
                    <a class="{{ Route::is('payment-policy') ? "active" : "" }}" href="{{ route('payment-policy') }}">Chính sách thanh toán</a>
                    <a class="{{ Route::is('delivery-policy') ? "active" : "" }}" href="{{ route('delivery-policy') }}">Chính sách giao hàng</a>
                    <a class="{{ Route::is('contact.*') ? "active" : "" }}"  href="{{ route('contact.index') }}">Liên hệ</a>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-10 col-xs-11">
                        <ul class="list-inline pull-right top-right">
                            <li class="account-login">
                                ...
                                @else
                                    <a href="{{ route('customer.order.list') }}" class="btn-logout">Đơn hàng của tôi</a>
                                @endguest
                            </li>
                            <li>
                                @auth
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu">
                                        <li><a href="{{ route('customer.info.show') }}">Thông tin tài khoản</a></li>
                                        <li><a href="{{ route('customer.shipping.show') }}">Địa chỉ giao hàng</a></li>
                                        <li><a href="{{ route('customer.order.list') }}">Đơn hàng của tôi</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 logo">
                        <a href="{{ route('home') }}"><img src="{{ asset('') }}images/goda450x170_1.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-lg-4 col-md-4 hidden-sm hidden-xs call-action">
                        <a href="{{ route('product.index') }}"><img src="{{ asset('') }}images/godakeben450x170.jpg" class="img-responsive"></a>
                    </div>
                    <!-- HOTLINE AND SERCH -->
                    <div class="col-lg-4 col-md-4 hotline-search">
                        <div>
                            <p class="hotline-phone"><span><strong>Hotline: </strong><a href="tel:0793.262.949">0793.262.949</a></span></p>
                            <p class="hotline-email"><span><strong>Email: </strong><a href="mailto:nguyenhuy280901@gmail.com">nguyenhuy280901@gmail.com</a></span></p>
                        </div>
                        <form class="header-form" action="{{ route('product.search') }}" method="POST">
                            @csrf
        ...
        <nav class="navbar navbar-default desktop-menu">
            <div class="container">
                <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                    ...
                    <li class="{{ Route::is('return-policy') ? "active" : "" }}">
                        <a href="{{ route('return-policy') }}">Chính sách đổi trả</a>
                    </li>
                    <li class="{{ Route::is('payment-policy') ? "active" : "" }}">
                        <a href="{{ route('payment-policy') }}">Chính sách thanh toán</a>
                    </li>
                    <li class="{{ Route::is('delivery-policy') ? "active" : "" }}">
                        <a href="{{ route('delivery-policy') }}">Chính sách giao hàng</a>
                    </li>
                ...
                @if (!Route::is('order.checkout'))
                    <ul class="nav navbar-nav navbar-right">
                        <li class="cart"><a href="javascript:void(0)" class="btn-cart-detail" title="Giỏ Hàng"><i class="fa fa-shopping-cart"></i> <span class="number-total-product">0</span></a></li>
                    </ul>
                @endif
            </div>
        </nav>
        @if(Route::is('home'))
            @include(config('constant.site_view').'layouts.banner')
        @endif
                        ...
                        <div class="row">
                                ...
                                <div class="footerLink">
                                    ...
                                    <ul class="list-unstyled">
                                        @foreach ($categories as $category)
                                            <li><a href="{{ route('product.index') }}?category_id={{ $category->id }}">{{ $category->name }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-4 list">
                                <div class="footerLink">
                                    ...
                                    <ul class="list-unstyled">
                                        <li>Phone: 0793.262.949</li>
                                        <li><a href="mailto:nguyenhuy280901@gmail.com">Mail: nguyenhuy280901@gmail.com</a></li>
                                    </ul>
                                    <ul class="list-inline">
                                        <li><a href="https://www.facebook.com/HocLapTrinhWebTaiNha.ThayLoc"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="https://twitter.com"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12 list">
                                <div class="newsletter clearfix">
                                    ...
                                    <form id="form-new-letter" action="" method="POST">
                                        <div class="">
                                            <div class="col-sm-10">
                    ...
                    <form action="{{ route('register') }}" method="POST" role="form">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name"  placeholder="Họ và tên" required oninvalid="this.setCustomValidity('Vui lòng nhập tên của bạn')" oninput="this.setCustomValidity('')">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group g-recaptcha" data-sitekey="{{ env('NOCAPTCHA_SITEKEY') }}"></div>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-color">
                        ...
                        <div class="text-center">
                            <a class="btn btn-primary google-login" href="{{ route('login-social', ['social' => 'google']) }}"><i class="fab fa-google"></i></i> Đăng nhập bằng Google</a>
                            <!-- Facebook login -->
                            <a class="btn btn-primary facebook-login" href="{{ route('login-social', ['social' => 'facebook']) }}"><i class="fab fa-facebook-f"></i> Đăng nhập bằng Facebook</a>
                        </div>
                    </div>
                    <form action="{{ route('login') }}" method="POST" role="form">
                        @csrf
                        <input type="hidden" name="login_by" value="form">
                        <div class="modal-body">
                            <div class="form-group">
        ...
        <div class="modal fade" id="modal-forgot-password" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('forgot') }}" method="POST" role="form">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
        ...
        @include(config('constant.site_view').'layouts.cart')
        ...
        <script>
            ...
            chatbox.setAttribute("page_id", "107902514932874");
